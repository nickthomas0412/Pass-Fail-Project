function [methodinfo,structs,enuminfo,ThunkLibName]=ps4000WrapMFile_maci64
%PS4000WRAPMFILE_MACI64 Create structures to define interfaces found in 'ps4000Wrap'.

%This function was generated by loadlibrary.m parser version  on Tue Apr 20 16:52:41 2021
%perl options:'ps4000Wrap.i -outfile=ps4000WrapMFile_maci64.m -thunkfile=ps4000Wrap_thunk_maci64.c -header=ps4000Wrap.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps4000Wrap_thunk_maci64');
