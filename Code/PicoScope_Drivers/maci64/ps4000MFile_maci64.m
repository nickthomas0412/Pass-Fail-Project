function [methodinfo,structs,enuminfo,ThunkLibName]=ps4000MFile_maci64
%PS4000MFILE_MACI64 Create structures to define interfaces found in 'ps4000Api'.

%This function was generated by loadlibrary.m parser version  on Tue Apr 20 15:52:45 2021
%perl options:'ps4000Api.i -outfile=ps4000MFile_maci64.m -thunkfile=ps4000_thunk_maci64.c -header=ps4000Api.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps4000_thunk_maci64');
